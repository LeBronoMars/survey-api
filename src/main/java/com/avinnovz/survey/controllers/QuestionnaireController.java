...
public class QuestionnaireController {
    ...
    public ResponseEntity<?> createDepartment(@Valid @RequestBody CreateQuestionnaireDto createQuestionnaireDto) throws URISyntaxException {
        ...
        try {
            ...
            final AppUser appUser = appUserService.findOne(createQuestionnaireDto.getCreatedBy());
